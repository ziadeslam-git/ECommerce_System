...
namespace ECommerce_System.Migrations
{
    ...
    [Migration("20260725100804_AddPerformanceIndexes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce_System.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce_System.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ECommerce_System.Models.GiftBundle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce_System.Models.GiftBundleProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce_System.Models.Shipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce_System.Models.Address", b =>
                {
                    b.HasOne("ECommerce_System.Models.ApplicationUser", "User")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("ECommerce_System.Models.CartItem", b =>
                {
                    ...
                    b.HasOne("ECommerce_System.Models.GiftBundle", "GiftBundle")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("ECommerce_System.Models.Category", b =>
                {
                    b.HasOne("ECommerce_System.Models.Category", "ParentCategory")
            ...
            modelBuilder.Entity("ECommerce_System.Models.Order", b =>
                {
                    b.HasOne("ECommerce_System.Models.Address", "Address")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("ECommerce_System.Models.Shipment", b =>
                {
                    b.HasOne("ECommerce_System.Models.Order", "Order")
                        .WithOne("Shipment")
                        .HasForeignKey("ECommerce_System.Models.Shipment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ECommerce_System.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
